...
\def\address{Cambridge, UK}
\def\languages{% Languages spoken
\en{Portuguese {\scriptsize (nat)}, english {\scriptsize (C1)}, french {\scriptsize (B2)}}
\fr{Portugais {\scriptsize (mat)}, anglais{\scriptsize (C1)}, français {\scriptsize (B2)}}
}
...
\section{
  ...
  \fr{Principales publications}
}
\input{sections/publications}

\section{
  \en{Other Activities \& information}
  \fr{Autres activités \& informations}
}
